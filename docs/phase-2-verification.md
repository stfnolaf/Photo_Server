...
- Independent static UI delivery through its same-origin API proxy, CORS support for direct `PATCH` requests, original download headers, derivative cache rebuilding, and pending/unavailable/failed preview responses.
